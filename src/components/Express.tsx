                ...
                <div className="carousel-inner">
                    <div className="carousel-item active" >
                        {imgP ? <img
                            ...
                            alt={imgP.name}
                        /> :
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-card-image card-img-top " viewBox="0 0 16 16" style={{ height: "10rem" }}>
                        ...
                        {imgP ? <div className="carousel-caption d-block" style={{ backgroundColor: "#22222233" }} >
                            <h3 className="d-none d-md-block p-0 m-0" style={{ color: "#eee" }}>{imgP.name}</h3>
                            <p className=" p-0 m-0 d-block d-md-none " style={{ color: "#eee" }}>{imgP.name}</p>
                            <h4 className="d-none d-md-block p-0 m-0" style={{ color: "#eee" }}>₡ {imgP.precio}</h4>
                        ...
                        imgs.map((img: any) => (
                            <div className="carousel-item " key={img.id}>
                                ...
                                {img.name.length !== 0 || img.precio.length !== 0 ?
                                    <div className="carousel-caption d-block" style={{ backgroundColor: "#22222233" }}>
                                        <h3 className="d-none d-md-block p-0 m-0" style={{ color: "#eee" }}>{img.name}</h3>
                                        <h6 className="  p-0 m-0 d-block d-md-none " style={{ color: "#eee" }}>{img.name}</h6>
                                        <h4 className="d-none d-md-block p-0 m-0" style={{ color: "#eee" }}>₡ {img.precio}</h4>
                                    </div> : null}
                            </div>
                        ))
                    }
